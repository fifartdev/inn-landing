...
const translations = {
    gr: {
        ...
        curriculum: {
            ...
            subtitle: "24 εξειδικευμένα μαθήματα από κορυφαίους επαγγελματίες του κλάδου",
            categories: {
                MANAGEMENT: "Διοίκηση",
    ...
    fr: {
        ...
        curriculum: {
            ...
            title: "Cours & Modules",
            subtitle: "24 cours spécialisés dispensés par des professionnels hôteliers de premier plan",
            categories: {
                MANAGEMENT: "Management",
...
_s(LanguageProvider, "lZXQucS04Sbo3aoui+NvneeU5J8=");
_c = LanguageProvider;
function useLang() {
    _s1();
...
_s(CookieBanner, "P49LNYdr55ddeyEXSMYI5gTZOF4=", false, function() {
    return [
...
//# sourceMappingURL=_47d26bdf._.js.map