...
const translations = {
    gr: {
        ...
        program: {
            tag: "Το Πρόγραμμα",
            title: "Diploma in Hotel Management",
            subtitle: "Πρόγραμμα Εξειδίκευσης στη Διοίκηση Ξενοδοχειακών Επιχειρήσεων",
            duration: "Διάρκεια",
            durationVal: "5 Μήνες",
            start: "Έναρξη",
        ...
        curriculum: {
            ...
            subtitle: "23 εξειδικευμένα μαθήματα από κορυφαίους επαγγελματίες του κλάδου",
            categories: {
                MANAGEMENT: "Διοίκηση",
        ...
        venues: {
            ...
            subtitle: "Τα masterclasses διεξάγονται σε εμβληματικά 5★ ξενοδοχεία της Αθήνας, προσφέροντας αυθεντική επαγγελματική εμπειρία.",
            venues: [
                {
        ...
        pricing: {
            ...
            earlyBird: {
                ...
                price: "1.700€",
                saving: "Εξοικονομείς 500€",
                installment1: "510€ με την εγγραφή (30%)",
                installment2: "1.190€ με την έναρξη (70%)",
            ...
            regular: {
                ...
                price: "2.200€",
                installment1: "1.100€ με την εγγραφή (50%)",
                installment2: "1.100€ έως 2 μήνες μετά (50%)",
    ...
    en: {
        ...
        venues: {
            ...
            subtitle: "Masterclasses take place at iconic 5★ hotels in Athens, offering authentic professional experience.",
            venues: [
                {
                    name: "Grand Hyatt Athens",
                    area: "Reception & Front Office",
        ...
        pricing: {
            ...
            earlyBird: {
                ...
                price: "€1,700",
                saving: "Save €500",
                installment1: "€510 on registration (30%)",
                installment2: "€1,190 on start date (70%)",
            ...
            regular: {
                ...
                price: "€2,200",
                installment1: "€1,100 on registration (50%)",
                installment2: "€1,100 within 2 months of start (50%)",
    ...
    fr: {
        ...
        curriculum: {
            ...
            title: "Cours & Modules",
            subtitle: "23 cours spécialisés dispensés par des professionnels hôteliers de premier plan",
            categories: {
                MANAGEMENT: "Management",
        ...
        venues: {
            ...
            subtitle: "Les masterclasses se déroulent dans des hôtels 5★ emblématiques d'Athènes, offrant une expérience professionnelle authentique.",
            venues: [
                {
                    name: "Grand Hyatt Athens",
        ...
        pricing: {
            ...
            earlyBird: {
                ...
                price: "1.700€",
                saving: "Économisez 500€",
                installment1: "510€ à l'inscription (30%)",
                installment2: "1.190€ au début des cours (70%)",
            ...
            regular: {
                ...
                price: "2.200€",
                installment1: "1.100€ à l'inscription (50%)",
                installment2: "1.100€ dans les 2 mois suivant le début (50%)",
        ...
        faq: {
            ...
            title: "Des Questions?",
            subtitle: "Trouvez des réponses aux questions les plus courantes sur le programme",
            items: [
                {
        ...
        form: {
            ...
            submitting: "Envoi...",
            success: "Votre candidature a été soumise! Nous vous contacterons bientôt.",
...
const LanguageContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])({
    lang: "gr",
    setLang: ()=>{},
    t: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["translations"]["gr"]
});
function LanguageProvider({ children }) {
    _s();
    const [lang, setLang] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("gr");
...
_s(LanguageProvider, "lduiWeo8NpXSUh8Hmb5lewxHgKI=");
_c = LanguageProvider;
function useLang() {
    _s1();
...
//# sourceMappingURL=_0824c46a._.js.map