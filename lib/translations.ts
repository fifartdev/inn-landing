  ...
  gr: {
    ...
    curriculum: {
      ...
      courseTitles: [
        ...
        "Διοίκηση Front Office & Guest Relations Management",
    ...
    france: {
      ...
      title: "Εκπαιδευτική Εκδρομή στη Γαλλία",
      subtitle:
        "4 ημέρες σε Παρίσι & Καμπανία — εκπαίδευση, πολιτισμός & Champagne experience",
      ...
      graduationDesc:
        "Οι απόφοιτοι προσκαλούνται στην επίσημη Graduation Ceremony του Paris Education, School of Hospitality — μια μοναδική εμπειρία που σφραγίζει την επαγγελματική σου πορεία.",
    },
    gallery: {
    ...
    fnb: {
      badge: "F&B Management Program",
      title: "Γίνε ο επόμενος F&B Manager.",
  ...
  en: {
    ...
    curriculum: {
      ...
      courseTitles: [
        ...
        "Front Office Management & Guest Relations Management",
    ...
    france: {
      ...
      graduationDesc:
        "Graduates are invited to the official Graduation Ceremony of Paris Education, School of Hospitality — a unique experience that marks your professional journey.",
    },
    gallery: {
      tag: "Photo Archive",
    ...
    professors: {
      ...
      professorSubjects: [
        ...
        "Mentoring & Coaching in Hospitality & Tourism",
        "Restaurant Technique & Service Management",
      ],
    },
    pricing: {
    ...
    fnb: {
      badge: "F&B Management Program",
      title: "Become the next F&B Manager.",
  ...
  fr: {
    ...
    curriculum: {
      ...
      courseTitles: [
        ...
        "Gestion du Front Office & Guest Relations Management",
    ...
    france: {
      ...
      graduationDesc:
        "Les diplômés sont invités à la cérémonie officielle de remise des diplômes du Paris Education, School of Hospitality — une expérience unique qui marque votre parcours professionnel.",
    },
    gallery: {
      tag: "Archives Photo",
    ...
    fnb: {
      badge: "F&B Management Program",
      title: "Devenez le prochain F&B Manager.",
...
export const courseData = [
  ...
  { id: 12, category: "HR",            title: "Ψυχολογία πάνω στο HR",                                     instructor: "Φανή Πασπαράκη",            instructorLatin: "Fani Pasparaki" },
  { id: 13, category: "MARKETING",     title: "Μάρκετινγκ Ξενοδοχειακών & Τουριστικών Υπηρεσιών",         instructor: "Μάριος Ανδρακάκης",         instructorLatin: "Marios Andrakakis",    guest: "Αντώνης Γιαννόπουλος", guestLatin: "Antonis Giannopoulos" },
  { id: 14, category: "MARKETING",     title: "Digital Marketing στον Τουρισμό & Ξενοδοχεία",              instructor: "Μάριος Ανδρακάκης",         instructorLatin: "Marios Andrakakis",    guest: "Αντώνης Γιαννόπουλος", guestLatin: "Antonis Giannopoulos" },
  ...
  { id: 18, category: "F&B",           title: "Υγιεινή & Ασφάλεια Τροφίμων (HACCP & ISO Standards)",      instructor: "Σταμάτης Λουμουσιώτης",     instructorLatin: "Stamatis Loumousiotis", guest: "Κωνσταντίνος Ντελέζος", guestLatin: "Konstantinos Ntelezos" },
  ...
  { id: 22, category: "FRONT OFFICE",  title: "Διοίκηση Front Office & Guest Relations Management",        instructor: "Κώστας Ανδριανόπουλος",     instructorLatin: "Kostas Andrianopoulos" },
  { id: 23, category: "FRONT OFFICE",  title: "Ψηφιακά Συστήματα Ξενοδοχείων (PMS, Channel Managers, CRM)", instructor: "Κώστας Ανδριανόπουλος",     instructorLatin: "Kostas Andrianopoulos", guest: "Κωνσταντίνος Σεργόπουλος", guestLatin: "Konstantinos Sergopoulos" },
...
export const professorsData = [
  ...
  { name: "Φανή Πασπαράκη", nameLatin: "Fani Pasparaki", category: "HR", linkedin: "https://www.linkedin.com/in/fani-pasparaki-61004974/", image: "/professors/fani_pasparaki.jpeg" },
  ...
  { name: "Γιώργος Καλογερόπουλος", nameLatin: "Giorgos Kalogeropoulos", category: "HOUSEKEEPING", linkedin: "https://www.linkedin.com/in/giorgos-kalogeropoulos-96074647/", image: "/professors/giorgos_kalogeropoulos.jpeg", guestSpeaker: true },
