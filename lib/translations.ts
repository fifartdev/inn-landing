...
export const courseData = [
  ...
  { id: 23, category: "FRONT OFFICE",  title: "Ψηφιακά Συστήματα Ξενοδοχείων (PMS, Channel Managers, CRM)", instructor: "Φανή Πασπαράκη",            instructorLatin: "Fani Pasparaki",       guest: "Κωνσταντίνος Σεργόπουλος", guestLatin: "Konstantinos Sergopoulos" },
