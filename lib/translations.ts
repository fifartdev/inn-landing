...
export const professorsData = [
  { name: "Γιώργος Πελακανάκης", nameLatin: "Giorgos Pelakanakis", category: "MANAGEMENT", linkedin: "#" },
  { name: "Γιώργος Σπυρόπουλος", nameLatin: "Giorgos Spyropoulos", category: "MANAGEMENT", linkedin: "#" },
  { name: "Αργύρης Νταουλιάρης", nameLatin: "Argyris Ntaoularis", category: "MANAGEMENT", linkedin: "#" },
  { name: "Ανθή Μανέτα", nameLatin: "Anthi Maneta", category: "MANAGEMENT", linkedin: "#" },
  { name: "Ιωάννα Ρώσση", nameLatin: "Ioanna Rossi", category: "MANAGEMENT", linkedin: "#" },
  { name: "Γιώτα Μπαλάφα", nameLatin: "Giota Balafa", category: "MANAGEMENT", linkedin: "#" },
  { name: "Ράνια Πάσσαρη", nameLatin: "Rania Passari", category: "HR", linkedin: "#" },
  { name: "Δημήτρης Βαλέργας", nameLatin: "Dimitris Valergas", category: "HR", linkedin: "#" },
  { name: "Βασιλική Σφονδύλη", nameLatin: "Vasiliki Sfondyli", category: "HR", linkedin: "#" },
  { name: "Αντώνης Γιαννόπουλος", nameLatin: "Antonis Giannopoulos", category: "MARKETING", linkedin: "#" },
  { name: "Μάριος Ανδρακάκης", nameLatin: "Marios Andrakakis", category: "SALES", linkedin: "#" },
  { name: "Σταμάτης Λουμουσιώτης", nameLatin: "Stamatis Loumousiotis", category: "F&B", linkedin: "#" },
  { name: "Κωνσταντίνος Ντελέζος", nameLatin: "Konstantinos Ntelezos", category: "F&B", linkedin: "#" },
  { name: "Φυλάκτου Γεωργία", nameLatin: "Georgia Fylaktou", category: "F&B", linkedin: "#" },
  { name: "Μαρία Κατσούλη", nameLatin: "Maria Katsouli", category: "F&B", linkedin: "#" },
  { name: "Φανή Πασπαράκη", nameLatin: "Fani Pasparaki", category: "FRONT OFFICE", linkedin: "#" },
  { name: "Κωνσταντίνος Σεργόπουλος", nameLatin: "Konstantinos Sergopoulos", category: "FRONT OFFICE", linkedin: "#" },
  { name: "Γιώργος Καλογερόπουλος", nameLatin: "Giorgos Kalogeropoulos", category: "HOUSEKEEPING", linkedin: "#" },
];
